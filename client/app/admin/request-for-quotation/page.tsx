...
const RequestForQuotation = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (fileList && fileList.length > 0) {
      ...
      setFiles([...files, ...selectedFiles]); // Append new files to the existing files array
    }
  };
  ...
  return (
    <Chakra>
      ...
      p={5}
    >
      <Heading mb={6}>Engineering Project RFQ</Heading>
        ...
        <Box flex="1" ml={{ md: 8 }}>
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <FormControl id="projectDescription" mt={4} isRequired>
              ...
              <Textarea placeholder="Max 1000 characters" maxLength={1000} />
            </FormControl>
